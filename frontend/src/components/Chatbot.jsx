...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: "bot",
      content:
        "Hi there! I can help you find products. Try asking for category, price range, sale, or stock.",
      products: [],
    },
  ]);
  ...
  const quickQuestions = [
    "what is on sale",
    "sale products under 30",
    "show low stock items",
    "mens under 40 in stock",
    "find black hoodie",
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: "bot",
          content:
            "I could not fetch live information right now, but you can contact OSAI@aston.ac.uk. What else can I help with?",
          products: [],
        },
      ]);
    } finally {
