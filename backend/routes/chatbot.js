...
function getSupportReply(message) {
  ...
  if (m.includes("refund") || m.includes("return")) {
    return "We accept returns within 30 days. To request a refund, go to your order history and click request refund, or contact OSAI@aston.ac.uk with your order number.";
  }
  ...
  if (m.includes("where are you") || m.includes("address") || m.includes("location")) {
    return "We are at 134a Aston Road, Birmingham, United Kingdom.";
  }
...
function getFallbackReply(message) {
  ...
  return "I can help you find products and answer support questions. Try 'sale products under 30' or 'black hoodie in stock'.";
}
